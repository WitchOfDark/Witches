...
//   FacebookAuthProvider({FacebookAuth? facebookAuth}) : _facebookAuth = facebookAuth ?? FacebookAuth.instance;
...
//       );
//       final String? photoUrl = userData['picture'] != null ? userData['picture']['data']['url'].toString() : null;
