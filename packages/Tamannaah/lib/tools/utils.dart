...
Map<String, dynamic> maptoJson(Map map,
    {bool removeNull = false, bool stringify = false, bool printType = false,}) {
...
/// Map
/// List
dynamic objToJson(dynamic obj, {bool stringify = false, bool printType = false, bool removeNull = false,}) {
  if (obj is Map) {
