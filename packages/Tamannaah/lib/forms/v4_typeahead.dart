...
class V4TypeAhead<T> extends FormBuilderField<T> {
  //--------------------------------------------------------
  final String? hint;
  final Widget? prefix;
  final Widget? label;
  ...
  final FutureOr<Iterable<T>> Function(String pattern, FormFieldState<T> field, TextEditingController textCon)
      suggestionsCallback;
...
//-----------------------------------------------------
            ...
            final decoration = d.iDeco(
              ...
              suffix: Row(
                ...
                children: [
                  ...
                  // ),
                  if (field.value != null && state.typeAheadController.text != '')
                    icoBtn(
                      Icons.close,
                      () {
                        state.typeAheadController.clear();
                  ...
                  icoBtn(
                    ...
                    () {
                      ...
                      // }
                      // state.suggestionsBoxController.resize();
                      state.suggestionsBoxController.toggle();
              ...
              child: header(
                ...
                child: TypeAheadField<T>(
                  textFieldConfiguration: textFieldConfiguration.copyWith(
                    ...
                    style: state.enabled ? d.ts() : d.disable(state.enabled).ts(),
                  ...
                  onSuggestionSelected: (T suggestion) {
                    ...
                    onSuggestionSelected?.call(suggestion, state.typeAheadController);
                  },
                  ...
                  suggestionsBoxController: state.suggestionsBoxController,
  ...
  @override
  V4TypeAheadState<T> createState() => V4TypeAheadState<T>();
}

class V4TypeAheadState<T> extends FormBuilderFieldState<V4TypeAhead<T>, T> {
  ...
  void initState() {
    super.initState();
    typeAheadController = widget.controller ?? TextEditingController(text: _getTextString(initialValue));
    suggestionsBoxController = widget.suggestionsBoxController ?? SuggestionsBoxController();
  ...
  void didChange(T? value) {
    ...
    if (typeAheadController.text != text) {
      typeAheadController.text = text;
    }
  }
  ...
  void reset() {
    ...
    typeAheadController.text = _getTextString(initialValue);
  }
