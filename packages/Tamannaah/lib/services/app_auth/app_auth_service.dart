...
class Auth0IdToken {
  ...
  bool can(String permission) =>
      permissions.where((p) => p == permission).isNotEmpty;
  final List<String> permissions;

  factory Auth0IdToken.fromRawJson(String str) =>
      Auth0IdToken.fromJson(json.decode(str));
  ...
  factory Auth0IdToken.fromJson(Map<String, dynamic> json) => Auth0IdToken(
        ...
        permissions: List<String>.from(
            json["https://users.marvel.app/permissions"]
...
class Auth0User {
  ...
  factory Auth0User.fromRawJson(String str) =>
      Auth0User.fromJson(json.decode(str));
