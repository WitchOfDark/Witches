...
// part 'settings_service_i.g.dart';
...
//   final HashMap<String, IsarSettings> _settingsMap =
//       HashMap<String, IsarSettings>();
...
//       IsarSettings s =
//           (await _isarSettingsBox?.get(1))?.copyWith(lastAppOpen: time) ??
//               IsarSettings(theme: 17, lastAppOpen: time);
