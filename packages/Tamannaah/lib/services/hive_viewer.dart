...
Widget hiveView(List<DropdownMenuItem<int>> buttons, DbService service) {
      ...
      HivePage(
        tab: BlocBuilder<SettingsBloc, SettingsState>(
          builder: (context, state) {
            SettingsService service = RepositoryProvider.of<SettingsService>(context);
          ...
          builder: (context, state) {
            ...
            List<DropdownMenuItem<int>> buttons = [
              ...
              DropdownMenuItem(
                ...
                onTap: () {
                  Settings settings = (bloc.state as SSettingsLoaded).settings;
                  bloc.add(
                    ESettingsUpdate(
                      settings.copyWith(theme: settings.theme == 0 ? 1 : 0),
                    ),
                  );
                },
              ),
